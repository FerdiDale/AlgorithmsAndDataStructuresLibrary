...
public:
  ...
  // Move assignment
  DictionaryContainer& operator=(DictionaryContainer&&) noexcept; // Move assignment of abstract types should not be possible.
...
template <typename Data>
class PreOrderMappableContainer : public virtual MappableContainer<Data> { // Must extend MappableContainer<Data>
